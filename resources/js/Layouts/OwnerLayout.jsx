...
export default function OwnerLayout({ children }) {
    ...
    const colors = {
        ...
        darkIndigo: '#4338CA',  // indigo-700
        veryDarkIndigo: '#3730A3', // indigo-800
        white: '#FFFFFF',
    };

    const navigation = [
        { name: 'Dashboard', href: route('owner.dashboard'), icon: HomeIcon },
        ...
        <div className="min-h-screen" style={{ backgroundColor: colors.white }}>
            ...
            >
                <div className="flex h-16 items-center justify-center border-b border-white/20">
                    ...
                    <p className="ml-2 text-xs text-white/70">Owner</p>
                </div>
                ...
                <header className="sticky top-0 z-10 shadow-sm border-b bg-white border-gray-200">
                    <div className="flex items-center justify-between px-6 py-3">
                        <button className="lg:hidden" onClick={() => setSidebarOpen(true)}>
                            <svg className="h-6 w-6" style={{ color: colors.indigo }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 12h16M4 18h16" />
                            </svg>
                        </button>
                        <h2 className="text-lg font-semibold text-gray-800">Owner Portal</h2>
