            ...
            <div className="space-y-6">
                ...
                <div className="flex flex-wrap justify-between items-center gap-4">
                    <div>
                        ...
                        <p className="text-gray-600">Manage your product catalog, variants, and bill of materials.</p>
                    </div>
                    <Link
                        href={route('admin.products.create')}
                        className="inline-flex items-center gap-2 rounded-lg bg-slate-700 px-4 py-2 text-white hover:bg-slate-800 transition shadow-sm"
                    >
                                ...
                                <div className="flex flex-wrap items-center p-4 gap-4">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <Link
                                            ...
                                            className="inline-flex items-center gap-1 px-3 py-1.5 text-sm text-slate-600 hover:text-slate-800 hover:bg-slate-50 rounded-lg transition"
                                        >
                                        ...
                                        <button
                                            ...
                                            className="inline-flex items-center gap-1 px-3 py-1.5 text-sm text-red-600 hover:text-red-800 hover:bg-red-50 rounded-lg transition"
                                        >
