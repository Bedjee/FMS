...
export default function Transactions({ material, transactions }) {
            ...
            <div className="space-y-6">
                <div className="flex justify-between items-center">
                    <h1 className="text-2xl font-bold text-gray-900">
                        {material.name} – Inventory History
                    </h1>
                    <Link href={route('supplier.materials.index')} className="text-purple-600 hover:text-purple-800">
                        ← Back to Materials
                    </Link>
                </div>
